                              ...
                              <div class="card-body ">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                      ...
                                      <input type="text" class="form-control" id="name" disabled name="fname" value="<?php echo $data['fname']; ?>" placeholder="File name">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label>Link:</label>
                                    <div class="input-group">
                                      ...
                                      <img src= "<?php echo "../../uploads/". $data['link'];?>" height="200px;" width="200px;">
                                    </div>
                                </div>
                              </div>
                          </div>
                              ...
                              <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                      ...
                                      <input type="text" class="form-control" id="text" disabled name="type" value="<?php echo $data['type']; ?>" placeholder="Type">
                                    </div>
                                </div>
                              </div>
                          </div>
