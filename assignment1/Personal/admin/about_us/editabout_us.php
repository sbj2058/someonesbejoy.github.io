...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
        <div class="container">
                <div class="title">
                    <h2 class="mb-3 p-2">Edit About Us</h2>
                </div>
                <?php
                if (isset($_GET['id'])) {
                $id = $_GET['id'];
                  ...
                  $description=$_POST['description'];
                      ...
                      if ($filesize <= 3000000) {
                          if ($extention == 'jpg' ||  $extention == 'JPG' || $extention == 'pdf' || $extention == 'PNG' || $extention == 'png' || $extention == 'gif' || $extention == 'jpeg') {
                              ...
                              {
                                  $query = "UPDATE aboutus SET title='$title', title_description='$title_description', info_title='$info_title',description='$description' WHERE id='$id'";
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <textarea name="title_description" cols="45" rows="3
                                                " value="">="<?php echo $data['title']; ?></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" id="text" name="info_title"
                                                    value="<?php echo $data['info_title']; ?>" placeholder="info_title">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <textarea name="description" cols="45" rows="3" value=""><?php echo $data['description']; ?></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
