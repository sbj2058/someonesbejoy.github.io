    ...
    <div class="wrapper">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                        ...
                        <div class="dropdown-divider"></div>
                        <a href="loginprocess/logout.php" class="dropdown-item">
                             Logout 
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="users/addusers.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Add users</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="users/manageusers.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Manage users</p>
                </a>
              </li>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="services/addservices.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Add Services</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="services/manageservices.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Manage Services </p>
                </a>
              </li>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="sliders/addsliders.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Add Sliders</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="sliders/managesliders.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Manage Sliders </p>
                </a>
              </li>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="ads/addads.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Add Ads</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="ads/manageads.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Manage Ads </p>
                </a>
              </li>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="gallery/addgallery.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Add Gallery</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="gallery/managegallery.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Manage Gallery </p>
                </a>
              </li>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="about_us/addabout_us.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Add About Us</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="about_us/manageabout_us.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Manage About Us </p>
                </a>
              </li>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="features/addfeatures.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Add Features</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="features/managefeatures.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Manage Features </p>
                </a>
              </li>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="testimonials/addtestimonials.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Add testimonal</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="testimonials/managetestimonials.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="blogs/addblogs.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Add Blog</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="blogs/manageblogs.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Manage Blog</p>
                </a>
              </li>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="side_config/addside_config.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Add Side Configuration</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="side_config/manageside_config.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Manage Side Configuration</p>
                </a>
              </li>
            </ul>
          </li>
